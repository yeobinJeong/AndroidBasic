                ...
                (new AlertDialog.Builder(this))
                        ...
                        .setItems(colors, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                switch (which) {
                                    case 0:
                                        myView.fillColor = Color.RED;
                                        break;
                                    case 1:
                                        myView.fillColor = Color.MAGENTA;
                                        break;
                                    case 2:
                                        myView.fillColor = Color.YELLOW;
                                        break;
                                    case 3:
                                        myView.fillColor = Color.GREEN;
                                        break;
                                    case 4:
                                        myView.fillColor = Color.BLUE;
                                        break;
                                }
                            }
                        })
